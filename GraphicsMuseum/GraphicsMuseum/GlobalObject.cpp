...
GlobalObject::GlobalObject(bool isMoving, vec3 position, vec3 rotation, vec3 scale, vec3 velocity, vec4 color) {
...
void GlobalObject::drawRect(float w, float h, float d, float r, float g, float b){
...
void GlobalObject::drawVecArrayBox(float w, float h, float d, float r, float g, float b, GlobalObject &objectToModify){
	glPushMatrix();
	glScalef(w,h,d);
...
void GlobalObject::drawVecArrayFace(float w, float h, float r, float g, float b, GlobalObject &objectToModify){
		/*
...
void GlobalObject::drawVecArrayCircle(int radialPoints, float radius, float r, float g, float b, GlobalObject &objectToModify){
		/*
...
void GlobalObject::updateAndRender(float timeStep, bool shouldFall, bool shouldRender) {
