...
bool Shader::Initialize(char * vertex_shader_file, char * fragment_shader_file)
{
	...
	this->do_flat_shading_handle = glGetUniformLocation(this->program_id, (const GLchar *) "do_flat_shading");
	glUseProgram(0);
...
// by David Wolff. Later note: I removed my use of exceptions so this
// code might exactly be David Wolff's again.
...
// This function is adapted from OpenGL 4.0 Shading Language Cookbook
// by David Wolff. Later note: see above.
